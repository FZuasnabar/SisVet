...
class HistorialMedicoFrame(wx.Frame):
    ...
    def create_pdf_report(self, data, file_path):
        ...
        line_drawing = Drawing(width, 0.4 * inch)
        ...
        description_paragraph = Paragraph(f"<b>Descripción:</b><br/> {description}", data_style)
        elements.append(description_paragraph)

        image_path = data.get('imagen', 'default_image.png')
        image_width = 140
        image_height = 130
        ...
        if os.path.exists(image_path):
            ...
            elements.append(Paragraph("Imagen no disponible", data_style))
