...
class FormularioHistorialDialog(wx.Dialog):
    def __init__(self, parent, data=None):
        super(FormularioHistorialDialog, self).__init__(parent, title="Formulario de Historial Médico", size=(500, 500))
        ...
        self.direccion_text = wx.TextCtrl(left_panel, style=wx.TE_MULTILINE)
        ...
        self.descripcion_text = wx.TextCtrl(left_panel, style=wx.TE_MULTILINE)
